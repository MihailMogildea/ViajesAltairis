...
public class ReservationLineConfiguration : IEntityTypeConfiguration<ReservationLine>
{
    public void Configure(EntityTypeBuilder<ReservationLine> builder)
    {
        ...
        builder.Property(e => e.BoardTypeId).HasColumnName("board_type_id").HasDefaultValue(1L).IsRequired();
        builder.Property(e => e.CheckInDate).HasColumnName("check_in_date").IsRequired();
        builder.Property(e => e.CheckOutDate).HasColumnName("check_out_date").IsRequired();
        builder.Property(e => e.NumRooms).HasColumnName("num_rooms").HasDefaultValue(1);
        builder.Property(e => e.NumGuests).HasColumnName("num_guests").IsRequired();
        builder.Property(e => e.PricePerNight).HasColumnName("price_per_night").HasColumnType("decimal(10,2)").IsRequired();
        builder.Property(e => e.BoardPricePerNight).HasColumnName("board_price_per_night").HasColumnType("decimal(10,2)").HasDefaultValue(0m);
        builder.Property(e => e.NumNights).HasColumnName("num_nights").IsRequired();
