...
namespace ViajesAltairis.Admin.Api.Tests.Features.Reviews;
...
public class ReviewsControllerTests
{
    ...
    public ReviewsControllerTests(AdminApiFactory factory)
    {
        _factory = factory;
    ...
    {
        var response = await _client.GetAsync("/api/reviews/999999");
