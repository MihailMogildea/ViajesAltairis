...
import type { HotelOption, RoomConfigOption, BoardOption, PaymentMethodOption, HotelProviderOption, RoomTypeOption, BoardTypeOption } from "../actions";
...
export default async function ReservationDetailPage({
  ...
  try {
    [reservation, statuses, lines, guests, hotels, roomConfigs, boardOptions, paymentMethods, hotelProviders, roomTypes, boardTypes] = await Promise.all([
